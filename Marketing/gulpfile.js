...
gulp.task('font-bootstrap', function() {
	return gulp.src(['node_modules/bootstrap-icons/font/fonts/*'])
  	.pipe(gulp.dest(distPath + '/assets/css/'+ template +'/fonts/'));
});
...
gulp.task('css-vendor', function(){
  return gulp.src([
	...
	.pipe(minifyCSS())
	.pipe(gulp.dest(distPath + '/assets/css/'+ template +'/'))
	.pipe(livereload());
});
...
gulp.task('js-vendor', function(){
  return gulp.src([
	...
	.pipe(gulp.dest(distPath + '/assets/js/'+ template +'/'))
	.pipe(livereload());
});
...
gulp.task('watch', function () {
  ...
  gulp.watch('scss/**/*.scss', gulp.series(gulp.parallel(['css-app'])));
});
...
gulp.task('webserver', function() {
  connect.server({
		name: 'Color Admin - One Page Parallax',
